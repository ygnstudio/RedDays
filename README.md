...
| 日历 | 官方渠道 | 说明 |
|---|---|---|
| **大陆法定节假日** | 国务院办公厅公告原文 | 直连解析，事件附通知链接，无推算成分 |
| **香港公众假期** | 特区政府 1823 官方 JSON | 同上 |
| **节气农历** | GB/T 33661-2017《农历的编算和颁行》 | 天文算法与紫金山天文台《中国天文年历》同一体系，日期层面无分歧 |
| **每日黄历** | **无官方标准** | 宜忌冲煞属民俗推演（择吉术），各流派互相矛盾，事件内已标注"仅供参考" |
| **回历每日** | 沙特官方 Umm al-Qura 民事历 | 日常换算即官方口径；宗教节日正统机制为见月官宣，个别年份比推算晚一天 |
| **民族节日** | 部分有官方口径 | 开斋节/古尔邦节以当地公告为准（描述内标注）；藏历新年与西藏自治区藏医院《西藏天文气象历书》一致（2026 年已对照官方解读）；泼水节、彝历新年按地方政府公告口径；火把节按农历六月二十四 |
| **基督教历** | 教会法固定算法 | 复活节 computus 就是官方算法本身，算出即官方日期；采用西方教会口径，东正教多数年份不同 |
